var groupNames = ['Licensor','Reviewer','Other','Author','Reviewer & Author'];		  
...
var a = [],
    b,x=0;
               for (b in sigInst.clusters) a.push('<div style="line-height:12px"><a href="#' + b + '"><divstyle="width:40px;height:12px;border:1px solid #fff;background:' + b + ';display:inline-block"></div> ' + groupNames[x++] + ' (' + sigInst.clusters[b].length + ' members)</a></div>');	
    //a.sort();
